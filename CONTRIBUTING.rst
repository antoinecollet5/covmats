...
Please report defects using the `GitHub Issue Tracker <https://github.com/antoinecollet5/covmats/issues>`_.
...
- Information about your environment (OS, Python version, covmats version)
...
`GitHub Issue Tracker <https://github.com/antoinecollet5/covmats/issues>`_.
...
covmats documentation, in docstrings, tutorials, or external resources such as blog posts and articles.
...
`labels <https://github.com/antoinecollet5/covmats/labels>`_ and milestones.
...
1. Fork the `covmats` repository on GitHub.

2. Clone your fork locally::

    $ git clone git@github.com:your_username/covmats.git
    $ cd covmats
